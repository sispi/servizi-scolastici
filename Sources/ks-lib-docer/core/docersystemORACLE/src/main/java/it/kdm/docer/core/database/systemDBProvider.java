...
//Oracle
        String query = "select t.*, s.description as serviceNameLabel, m.displayname as methodNameLabel " +
                ...
                "t.serviceName = s.groupname and " +
                "t.methodName = m.methodname and " +
                "(t.data between TO_TIMESTAMP_TZ(?,'YYYY-MM-DD HH24:MI:SS TZH:TZM') and TO_TIMESTAMP_TZ(?,'YYYY-MM-DD HH24:MI:SS TZH:TZM')) ";
...
//        sdf.setTimeZone(TimeZone.getTimeZone(tz));
        ...
        String fromS = sdf.format(from.getTime());
        data.add(fromS);
        ...
        String toS = sdf.format(to.getTime());
        data.add(toS);
