 ...
 */
public class PrimaRegistrazioneImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements it.gov.digitpa.www.protocollo.PrimaRegistrazione
{
    
    public PrimaRegistrazioneImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
