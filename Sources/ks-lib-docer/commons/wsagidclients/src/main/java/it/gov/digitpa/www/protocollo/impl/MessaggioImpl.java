 ...
 */
public class MessaggioImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements it.gov.digitpa.www.protocollo.Messaggio
{
    
    public MessaggioImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    private static final javax.xml.namespace.QName DESCRIZIONEMESSAGGIO$2 = 
        new javax.xml.namespace.QName("http://www.digitPa.gov.it/protocollo/", "DescrizioneMessaggio");
    private static final javax.xml.namespace.QName PRIMAREGISTRAZIONE$4 = 
    ...
    public it.gov.digitpa.www.protocollo.DescrizioneMessaggio getDescrizioneMessaggio()
    {
        synchronized (monitor())
        {
            ...
            target = (it.gov.digitpa.www.protocollo.DescrizioneMessaggio)get_store().find_element_user(DESCRIZIONEMESSAGGIO$2, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public boolean isSetDescrizioneMessaggio()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(DESCRIZIONEMESSAGGIO$2) != 0;
        }
    }
    ...
    public void setDescrizioneMessaggio(it.gov.digitpa.www.protocollo.DescrizioneMessaggio descrizioneMessaggio)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (it.gov.digitpa.www.protocollo.DescrizioneMessaggio)get_store().add_element_user(DESCRIZIONEMESSAGGIO$2);
            }
    ...
    public void unsetDescrizioneMessaggio()
    {
        ...
        {
            check_orphaned();
            get_store().remove_element(DESCRIZIONEMESSAGGIO$2, 0);
        }
    }
    ...
    public it.gov.digitpa.www.protocollo.PrimaRegistrazione getPrimaRegistrazione()
    {
        synchronized (monitor())
        {
            ...
            target = (it.gov.digitpa.www.protocollo.PrimaRegistrazione)get_store().find_element_user(PRIMAREGISTRAZIONE$4, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public boolean isSetPrimaRegistrazione()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(PRIMAREGISTRAZIONE$4) != 0;
        }
    }
    ...
    public void setPrimaRegistrazione(it.gov.digitpa.www.protocollo.PrimaRegistrazione primaRegistrazione)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (it.gov.digitpa.www.protocollo.PrimaRegistrazione)get_store().add_element_user(PRIMAREGISTRAZIONE$4);
            }
    ...
    public void unsetPrimaRegistrazione()
    {
        ...
        {
            check_orphaned();
            get_store().remove_element(PRIMAREGISTRAZIONE$4, 0);
        }
    }
}
