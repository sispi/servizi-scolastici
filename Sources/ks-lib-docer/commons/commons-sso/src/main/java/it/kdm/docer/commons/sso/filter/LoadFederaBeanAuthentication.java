 ...
 */
public class LoadFederaBeanAuthentication implements Filter {

    private static Logger log = org.slf4j.LoggerFactory.getLogger(LoadFederaBeanAuthentication.class);
    ...
    public void init(FilterConfig filterConfig) throws ServletException {
        ...
        authBeanFile = new File(filterConfig.getInitParameter("authBeanPath"));
    ...
    public void doFilter(ServletRequest servletRequest, ServletResponse servletResponse, FilterChain filterChain) throws IOException, ServletException {
        ...
        try {
            Object authBean = null;

            if (authBeanFile.exists() && FileUtils.sizeOf(authBeanFile) > 0) {
                byte[] bs = FileUtils.readFileToByteArray(authBeanFile);
                authBean = SerializationUtils.deserialize(bs);
            }
