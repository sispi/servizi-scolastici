...
public class HandlerQRBExceptionException extends Exception{
    ...
    private it.kdm.docer.digitalstamp.provider.intesi.stub.HandlerStub.HandlerQRBException faultMessage;
    ...
    public void setFaultMessage(it.kdm.docer.digitalstamp.provider.intesi.stub.HandlerStub.HandlerQRBException msg){
       faultMessage = msg;
    }

    public it.kdm.docer.digitalstamp.provider.intesi.stub.HandlerStub.HandlerQRBException getFaultMessage(){
       return faultMessage;
    }
}
