 ...
 */
public class PerConoscenzaImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements it.gov.digitpa.www.protocollo.PerConoscenza
{
    
    public PerConoscenzaImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
     ...
     */
    public it.gov.digitpa.www.protocollo.PerConoscenza.ConfermaRicezione.Enum getConfermaRicezione()
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            return (it.gov.digitpa.www.protocollo.PerConoscenza.ConfermaRicezione.Enum)target.getEnumValue();
        }
    }
     ...
     */
    public it.gov.digitpa.www.protocollo.PerConoscenza.ConfermaRicezione xgetConfermaRicezione()
    {
        synchronized (monitor())
        {
            check_orphaned();
            it.gov.digitpa.www.protocollo.PerConoscenza.ConfermaRicezione target = null;
            target = (it.gov.digitpa.www.protocollo.PerConoscenza.ConfermaRicezione)get_store().find_attribute_user(CONFERMARICEZIONE$4);
            if (target == null)
            {
                target = (it.gov.digitpa.www.protocollo.PerConoscenza.ConfermaRicezione)get_default_attribute_value(CONFERMARICEZIONE$4);
            }
            return target;
        }
    }
     ...
     */
    public void setConfermaRicezione(it.gov.digitpa.www.protocollo.PerConoscenza.ConfermaRicezione.Enum confermaRicezione)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public void xsetConfermaRicezione(it.gov.digitpa.www.protocollo.PerConoscenza.ConfermaRicezione confermaRicezione)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (it.gov.digitpa.www.protocollo.PerConoscenza.ConfermaRicezione)get_store().add_attribute_user(CONFERMARICEZIONE$4);
            }
     ...
     */
    public static class ConfermaRicezioneImpl extends org.apache.xmlbeans.impl.values.JavaStringEnumerationHolderEx implements it.gov.digitpa.www.protocollo.PerConoscenza.ConfermaRicezione
    {
