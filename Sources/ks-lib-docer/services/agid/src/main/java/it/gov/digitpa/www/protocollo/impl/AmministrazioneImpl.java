 ...
 */
public class AmministrazioneImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements it.gov.digitpa.www.protocollo.Amministrazione
{
    
    public AmministrazioneImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    private static final javax.xml.namespace.QName CODICEAMMINISTRAZIONE$2 = 
    ...
    public it.gov.digitpa.www.protocollo.CodiceAmministrazione getCodiceAmministrazione()
    {
        synchronized (monitor())
        {
            ...
            target = (it.gov.digitpa.www.protocollo.CodiceAmministrazione)get_store().find_element_user(CODICEAMMINISTRAZIONE$2, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public boolean isSetCodiceAmministrazione()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(CODICEAMMINISTRAZIONE$2) != 0;
        }
    }
    ...
    public void setCodiceAmministrazione(it.gov.digitpa.www.protocollo.CodiceAmministrazione codiceAmministrazione)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (it.gov.digitpa.www.protocollo.CodiceAmministrazione)get_store().add_element_user(CODICEAMMINISTRAZIONE$2);
            }
    ...
    public void unsetCodiceAmministrazione()
    {
        ...
        {
            check_orphaned();
            get_store().remove_element(CODICEAMMINISTRAZIONE$2, 0);
        }
    }
