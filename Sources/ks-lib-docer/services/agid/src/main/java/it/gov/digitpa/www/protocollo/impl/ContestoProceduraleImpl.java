 ...
 */
public class ContestoProceduraleImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements it.gov.digitpa.www.protocollo.ContestoProcedurale
{
    
    public ContestoProceduraleImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    private static final javax.xml.namespace.QName TIPOCONTESTOPROCEDURALE$6 = 
    ...
    private static final javax.xml.namespace.QName DATAAVVIO$12 = 
        new javax.xml.namespace.QName("http://www.digitPa.gov.it/protocollo/", "DataAvvio");
    private static final javax.xml.namespace.QName NOTE$14 = 
        new javax.xml.namespace.QName("http://www.digitPa.gov.it/protocollo/", "Note");
    private static final javax.xml.namespace.QName PIUINFO$16 = 
    ...
    public it.gov.digitpa.www.protocollo.TipoContestoProcedurale getTipoContestoProcedurale()
    {
        synchronized (monitor())
        {
            ...
            target = (it.gov.digitpa.www.protocollo.TipoContestoProcedurale)get_store().find_element_user(TIPOCONTESTOPROCEDURALE$6, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public boolean isSetTipoContestoProcedurale()
    {
        synchronized (monitor())
        {
            check_orphaned();
            return get_store().count_elements(TIPOCONTESTOPROCEDURALE$6) != 0;
        }
    }
    ...
    public void setTipoContestoProcedurale(it.gov.digitpa.www.protocollo.TipoContestoProcedurale tipoContestoProcedurale)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (it.gov.digitpa.www.protocollo.TipoContestoProcedurale)get_store().add_element_user(TIPOCONTESTOPROCEDURALE$6);
            }
     ...
     */
    public void unsetTipoContestoProcedurale()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(TIPOCONTESTOPROCEDURALE$6, 0);
        }
    }
    ...
    public it.gov.digitpa.www.protocollo.DataAvvio getDataAvvio()
    {
        synchronized (monitor())
        {
            ...
            target = (it.gov.digitpa.www.protocollo.DataAvvio)get_store().find_element_user(DATAAVVIO$12, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public boolean isSetDataAvvio()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(DATAAVVIO$12) != 0;
        }
    }
    ...
    public void setDataAvvio(it.gov.digitpa.www.protocollo.DataAvvio dataAvvio)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (it.gov.digitpa.www.protocollo.DataAvvio)get_store().add_element_user(DATAAVVIO$12);
            }
    ...
    public void unsetDataAvvio()
    {
        ...
        {
            check_orphaned();
            get_store().remove_element(DATAAVVIO$12, 0);
        }
    }
    ...
    public it.gov.digitpa.www.protocollo.Note getNote()
    {
        synchronized (monitor())
        {
            ...
            target = (it.gov.digitpa.www.protocollo.Note)get_store().find_element_user(NOTE$14, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public boolean isSetNote()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(NOTE$14) != 0;
        }
    }
    ...
    public void setNote(it.gov.digitpa.www.protocollo.Note note)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (it.gov.digitpa.www.protocollo.Note)get_store().add_element_user(NOTE$14);
            }
            target.set(note);
        }
    }
    ...
    public void unsetNote()
    {
        ...
        {
            check_orphaned();
            get_store().remove_element(NOTE$14, 0);
        }
    }
    ...
    public it.gov.digitpa.www.protocollo.PiuInfo getPiuInfo()
    {
        synchronized (monitor())
        {
            ...
            target = (it.gov.digitpa.www.protocollo.PiuInfo)get_store().find_element_user(PIUINFO$16, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public boolean isSetPiuInfo()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(PIUINFO$16) != 0;
        }
    }
    ...
    public void setPiuInfo(it.gov.digitpa.www.protocollo.PiuInfo piuInfo)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (it.gov.digitpa.www.protocollo.PiuInfo)get_store().add_element_user(PIUINFO$16);
            }
            target.set(piuInfo);
        }
    }
    ...
    public void unsetPiuInfo()
    {
        ...
        {
            check_orphaned();
            get_store().remove_element(PIUINFO$16, 0);
        }
    }
