...
import it.emilia_romagna.regione.www.rer_fonte_raccoglitore.RerFonteRaccoglitoreSecurityProxy;
...
public class RerFonteTestClient {
	...
	public static void testSearchEntitaInformativaAvanzata() throws RemoteException {
		RerFonteRaccoglitoreSecurityProxy rerFonteRaccoglitoreProxy = new RerFonteRaccoglitoreSecurityProxy(endpoint);
		RerFonteRaccoglitore rerFonteRaccoglitore = rerFonteRaccoglitoreProxy.getRerFonteRaccoglitore(federaData);
