...
public class FieldDescriptor {
    ...
    boolean inheritedFromBase = true;
...
//                        throw new DocerException("Errore definizione nodi fields: campo format: schemaLocation fa riferimento ad un file XSD non esistente per il nodo: " + propName);
//                    }
                }
                else{
                    try {
            ...
            if (type.equals(EnumBLPropertyType.DATE) || type.equals(EnumBLPropertyType.DATETIME)) {
                ...
                if (dateFormatMessage != null) {
                    ...
                    if (!matcher.find()) {
                        ...
                        if (!matcher.find()) {
                            throw new DocerException("il metadato " + propName + " di tipo " + type + " ha formato errato: atteso ISO8601 nel formato completo oppure YYYY-MM-DD oppure YYYY-MM-DDThh:mm:ss oppure YYYY-MM-DD hh:mm:ss");
                        }
...
//                }
	...
	public boolean isInheritedFromBase() {
		return inheritedFromBase;
	}

	public void setInheritedFromBase(boolean inheritedFromBase) {
		this.inheritedFromBase = inheritedFromBase;
	}
