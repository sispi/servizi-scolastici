...
public class DocumentType {
	...
	private Map<String,FieldDescriptor> eligibleFields = new HashMap<String,FieldDescriptor>();
	...
	public void addEligibleField(FieldDescriptor field){
		
		if(eligibleFields.containsKey(field.getPropName())){
			return;
		}
		
		eligibleFields.put(field.getPropName(), field);		
	}	
