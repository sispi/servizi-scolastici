...
import it.kdm.docer.providers.solr6.bl.anagrafiche.AnagraficaBL;
import it.kdm.docer.providers.solr6.bl.documenti.DocumentoBL;
import it.kdm.docer.providers.solr6.bl.sicurezza.AttoriBL;
import it.kdm.docer.providers.solr6.bo.LoginBO;
...
public class Provider extends SolrBaseUtil implements IProvider {
    ...
    public Provider() throws DocerException {
        ...
        if (Strings.isNullOrEmpty(zkHost)){
            zkHost = this.config.getProperty(Configuration.Keys.ZK_HOST);
            System.setProperty("zkHost",zkHost);
        }
        //SolrClient.setZkHost();
    }
