package it.kdm.docer.providers.solr4;

import it.kdm.docer.providers.solr4.bl.Configuration;
import it.kdm.docer.providers.solr4.bl.documenti.DocumentoBL;
import it.kdm.docer.providers.solr4.bl.anagrafiche.AnagraficaBL;
import it.kdm.docer.providers.solr4.bl.sicurezza.AttoriBL;
import it.kdm.docer.providers.solr4.bo.LoginBO;
 ...
 */
public class Provider extends SolrBaseUtil implements IProvider {
    ...
    public Provider() throws DocerException {
        super();
        SolrClient.setZkHost(this.config.getProperty(Configuration.Keys.ZK_HOST));
    }
