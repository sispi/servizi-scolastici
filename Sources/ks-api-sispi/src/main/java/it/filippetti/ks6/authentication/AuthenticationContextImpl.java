 ...
 */
package it.filippetti.ks6.authentication;

import io.jsonwebtoken.JwtException;
import it.filippetti.ks6.ApplicationContextHolder;
import it.filippetti.ks6.configuration.ApplicationProperties;
import it.filippetti.ks6.service.IdentityService;
...
public class AuthenticationContextImpl implements AuthenticationContext, Authentication {
	...
	public AuthenticationContextImpl(HttpServletRequest request) throws AuthenticationException {
		...
		authorities.addAll(roles.stream().map(r -> Authority.role(r)).collect(Collectors.toSet()));
