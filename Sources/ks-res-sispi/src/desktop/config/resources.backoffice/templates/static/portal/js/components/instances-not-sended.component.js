    ...
    var instancesNotSended = {
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                <tr v-for="instance in page.data">
                                    ...
                                    <td>Salvato</td>
                                    <td>
                                        <a v-bind:href="'/portal/features/update-instance-start?upid=' + instance.id" class="btn btn-primary btn-xs"> <span class="glyphicon glyphicon-pencil"></span> Completa </a>
        ...
        methods: {
            ...
            nextPage: function () {
                ...
                this.page = FindAllInstancesNotSended(this.currentPage, 10);
            },
