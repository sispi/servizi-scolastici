    ...
    <div class="container">
            ...
            <div class="it-brand-wrapper">
              <a href="/public/index">
                ...
                <div class="it-brand-text">
                  <h2 class="no_toc">Comune di Palermo</h2>
                </div>
              </a>
            </div>
          </div>
          <div class="col-sm-8">
            <span id="logo-footer-ponmetro">
              <img style="height: 70px; float: right; margin-top: 16px;" src="/static/img/ponmetro.jpg" >
            </span>
          </div>
        </div>
      </section>
      ...
      <section>
        <div class="row">
          <div class="col-lg-3 col-md-3 col-sm-6 pb-2">
            ...
            <div class="link-list-wrapper">
              <ul class="footer-list link-list clearfix">
                ...
                <li><a class="list-item" href="#" title="Vai alla pagina: Associazioni e societa' partecipate">Associazioni e societa' partecipate</a></li>
              </ul>
            </div>
          </div>
          <div class="col-lg-3 col-md-3 col-sm-6 pb-2">
          ...
          <div class="col-lg-3 col-md-3 col-sm-6 pb-2">
            <h4>
              <a href="#" title="Vai alla pagina: Novita'">Novita'</a>
            </h4>
            <div class="link-list-wrapper">
              <ul class="footer-list link-list clearfix">
          ...
          <div class="col-lg-3 col-md-3 col-sm-6">
            ...
            <div class="link-list-wrapper">
              <ul class="footer-list link-list clearfix">
                <li><a class="list-item" href="#" title="Vai alla pagina: Progetti e attivita'">Progetti e attivita'</a></li>
      ...
      <section class="py-4 border-white border-top">
        <div class="row">
          <div class="col-lg-4 col-md-4 pb-2">
            ...
            <p>
              <strong>Comune di Palermo</strong><br> Sede istituzionale - Palazzo delle Aquile<br>Piazza Pretoria, 1<br>+39 091 7401111<br>C.F. 80016350821
            </p>
          </div>
          <div class="col-lg-4 col-md-4 pb-2">
            <h4><a href="#" title="Vai alla pagina: Lorem Ipsum">Recapiti</a></h4>
            <div class="link-list-wrapper">
              <ul class="footer-list link-list clearfix">
                <li>Posta Elettronica Certificata (PEC)  <a class="list-item" href="mailto:protocollo@cert.comune.palermo.it">protocollo@cert.comune.palermo.it</a></li>
                <li>URP - Ufficio Relazioni con il Pubblico  <a class="list-item" href="mailto:urp@comune.palermo.it">urp@comune.palermo.it</a></li>
              </ul>
            </div>
          </div>
          <div class="col-lg-4 col-md-4 pb-2">
