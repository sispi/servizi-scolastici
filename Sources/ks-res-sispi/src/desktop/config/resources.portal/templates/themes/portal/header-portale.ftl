      ...
      <div class="row">
        <div class="col-12">
          <div class="it-header-slim-wrapper-content">
            <a class="d-none d-lg-block navbar-brand" href="https://portalescuola.comune.palermo.it/" target="_blank">PORTALE SCUOLA</a>
            <div class="nav-mobile">
              <nav>
                <a class="it-opener d-lg-none" data-toggle="collapse" href="#menu1" role="button" aria-expanded="false" aria-controls="menu1">
                  <span>PORTALE SCUOLA</span>
                  &nbsp;<i class="fa fa-expand" aria-hidden="true"></i>
                </a>
                <div class="link-list-wrapper collapse" id="menu1">
                  <#if utils.userInfo.authenticated >
                    <#if utils.userInfo.username!='guest' >
                    <ul class="link-list">
                      <li>
                        <a href="/portal/user/myProfile" class="list-item" title="${utils.userInfo.claims.PREFERRED_USERNAME!utils.userInfo.username}">
          ...
          <div class="it-header-center-content-wrapper">
            ...
            <div class="it-right-zone">
              <div class="it-search-wrapper">
                ...
                -->
                <#if !$.userInfo.isGuest() >
                  <span class="d-none d-md-block menu-search">Attività da svolgere</span>
