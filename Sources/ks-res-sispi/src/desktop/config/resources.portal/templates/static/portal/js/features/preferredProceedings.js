            ...
            <table class="table">
                <thead>
                    <tr>
                        ...
                        <th style="text-align: center" scope="col">Avviabile</th>
                        <th scope="col"></th>
                    </tr>
                </thead>
                <tbody>
                    <tr v-for="preferredProceeding in preferredProceedings">
                        ...
                        <td style="text-align: center" v-if="preferredProceeding.proceeding.isActive"><i style="color:#008758" class="fa fa-thumbs-up" aria-hidden="true" title="Procedimento avviabile"></i></td>
                        <td style="text-align: center" v-else><i style="color:#d9364f" class="fa fa-hand-paper" aria-hidden="true" title="Procedimento non avviabile"></i></td>
                        <td>
                            <a style="min-width: 80px;" v-bind:href="'/public/proceedingDetail?id=' + preferredProceeding.proceeding.id" class="btn btn-primary btn-xs"> <i class="fa fa-eye" aria-hidden="true"></i> Vedi </a>
