...
import { FindAllCompletedInstances } from "/static/portal/js/services/myPractice.service.js?no-cache";
import { AssociateServiceAndProceeding } from "/static/utilities/proceeding.utilities.js?no-cache";
export function InstancesCompleted() {
    var instancesCompleted = {
        template: `
        <div class="container step-container">
            <div v-if="!serverError">
                ...
                <div v-else>
                    <p>Di seguito trovi le pratiche concluse</p>
        ...
        methods: {
            ...
            nextPage: function () {
                ...
                const res = FindAllCompletedInstances(this.currentPage, 10);
        ...
        created() {
            const completedInstancesResponse = FindAllCompletedInstances(1, 10);
            if (completedInstancesResponse.status === "success") {
                this.page = completedInstancesResponse.data;
