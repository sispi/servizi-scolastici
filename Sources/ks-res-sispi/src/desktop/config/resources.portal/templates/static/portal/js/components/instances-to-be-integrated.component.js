...
import { FindAllInstancesToCompileByUser } from "/static/portal/js/services/myPractice.service.js?no-cache";
import { AssociateServiceAndProceeding } from "/static/utilities/proceeding.utilities.js?no-cache";
export function InstancesToBeIntegrated() {
    var instancesToBeIntegrated = {
        template: `
        <div class="container step-container">
            <div v-if="!serverError">
                ...
                <div v-else>
                    <p>Di seguito trovi le pratiche da integrare</p>
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                <tr v-for="instance in page.data">
                                    ...
                                    <td>
                                        <a v-bind:href="'/portal/features/proceedingInstanceManage?id=' + instance.id" class="btn btn-primary btn-xs"> <span class="glyphicon glyphicon-pencil"></span> Completa </a>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
        ...
        methods: {
            ...
            nextPage: function () {
                ...
                const res = FindAllInstancesToCompileByUser(this.currentPage, 10);
        ...
        created() {
            const InstancesToCompileByUserResponse = FindAllInstancesToCompileByUser(1, 10);
            if (InstancesToCompileByUserResponse.status === "success") {
                this.page = InstancesToCompileByUserResponse.data;
    ...
    return instancesToBeIntegrated;
}
