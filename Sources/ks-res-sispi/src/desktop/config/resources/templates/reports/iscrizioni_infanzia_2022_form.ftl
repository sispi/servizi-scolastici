...
<div class='report-search-form'>
 <h2>Ricerca Iscrizioni Infanzia</h2>
 <form action='/reports/report' method='GET'>
  <div class='panel panel-default'>
   <input type='hidden' name='qt' value='iscrizioni_infanzia_2022'>
...
function initAutoCompleteCFMinore(){
	...
	$('#cfRichiedente').tokenInput('/docer/v1/report?qt=autocomplete_codicefiscale_infanzia_rest', settingsTokenInput);
}
