...
<div class='report-search-form'>
 <h2>Ricerca Iscrizioni Nido</h2>
 <form action='/reports/report' method='GET'>
  <div class='panel panel-default'>
   <input type='hidden' name='qt' value='iscrizioni_nido_2022'>
...
function initAutoCompleteCFMinore(){
	...
	$('#cfRichiedente').tokenInput('/docer/v1/report?qt=autocomplete_codicefiscale_nido_rest', settingsTokenInput);
}
