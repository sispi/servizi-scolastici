...
public class EliminaRelated extends DocerAction {

	private final static Logger log = LoggerFactory.getLogger(docer.action.EliminaRelated.class);
	...
	public Map<String, Object> execute(Map<String, Object> inputs)throws ActionRuntimeException {
        ...
        try {
            ...
            DocerService.scorrelaDocumenti(token,documento.getDocNum(),listaDocNum);
