...
import it.kdm.doctoolkit.services.InvioDocumento;
...
public class InvioDocumentoDocer extends DocerAction {
	...
	public Map<String, Object> execute(Map<String, Object> inputs)throws ActionRuntimeException {
		...
		try {
			...
			Map<String, String> esito1 = InvioDocumento.invioDocumento(token, new Long(documento.getDocNum()), pecObject);


			result.put("esito", esito1);
