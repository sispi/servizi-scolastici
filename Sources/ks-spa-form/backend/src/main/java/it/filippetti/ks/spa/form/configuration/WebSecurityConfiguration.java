...
import it.filippetti.ks.spa.form.authentication.AuthenticationEntryPoint;
import it.filippetti.ks.spa.form.authentication.AuthenticationFilter;
        ...
        httpSecurity
            ...
            .authorizeRequests()
                .antMatchers(
                    ...
                    "/index.html", 
                    "/console")
                    .hasRole(ApplicationProperties.get().adminRole())
