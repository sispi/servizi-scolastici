...
public class SwaggerConfiguration {
    ...
    private static final String DESCRIPTION = ""
        ...
        + "<p><i>GET /forms/{id}?fetch=backups(definition),definition,schema</i></p>"
        + "<p>In this case, you get a form detail, including backups definition and schema. For each backup get the definition.</p>"
        ...
        + "<p><i>GET /forms?orderBy=name:ASC</i></p>"
        ...
        + "<p>For this purpose, each non-idempotent operation can include the <b>operationId</b> argument in the input payload to be valued by the client with a UUID value.</p>"
    ...
    public Docket docket(ServletContext servletContext) {
        return new Docket(DocumentationType.SWAGGER_2)
            .select()
            .apis(RequestHandlerSelectors.basePackage("it.filippetti.ks.spa.form.endpoint"))
