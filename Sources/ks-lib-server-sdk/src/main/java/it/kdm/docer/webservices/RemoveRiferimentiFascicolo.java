 ...
 *         &lt;element name="riferimenti" type="{http://classes.sdk.docer.kdm.it/xsd}SearchItem" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "removeRiferimentiFascicolo")
public class RemoveRiferimentiFascicolo {
    ...
    @XmlElement(nillable = true)
    protected List<SearchItem> riferimenti;
     ...
     * 
     */
    public List<SearchItem> getRiferimenti() {
        if (riferimenti == null) {
            riferimenti = new ArrayList<SearchItem>();
        }
