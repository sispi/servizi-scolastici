...
@XmlRootElement(name = "replaceLastVersion")
public class ReplaceLastVersion {
    ...
    @XmlElementRef(name = "file", namespace = "http://webservices.docer.kdm.it", type = JAXBElement.class, required = false)
    protected JAXBElement<DataHandler> file;
     ...
     *     
     */
    public JAXBElement<DataHandler> getFile() {
        return file;
    }
     ...
     *     
     */
    public void setFile(JAXBElement<DataHandler> value) {
        this.file = value;
    }
