...
@XmlRootElement(name = "protocollaByIdResponse")
public class ProtocollaByIdResponse {

    @XmlElementRef(name = "return", namespace = "http://protocollazione.docer.kdm.it", type = JAXBElement.class, required = false)
