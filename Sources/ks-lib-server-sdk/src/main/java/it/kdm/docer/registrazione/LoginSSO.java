...
public class LoginSSO {
    ...
    @XmlElementRef(name = "saml", namespace = "http://registrazione.docer.kdm.it", type = JAXBElement.class, required = false)
    protected JAXBElement<String> saml;
    @XmlElementRef(name = "codiceEnte", namespace = "http://registrazione.docer.kdm.it", type = JAXBElement.class, required = false)
