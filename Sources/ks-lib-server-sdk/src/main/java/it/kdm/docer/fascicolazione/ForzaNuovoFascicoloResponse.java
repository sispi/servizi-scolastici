...
@XmlRootElement(name = "forzaNuovoFascicoloResponse")
public class ForzaNuovoFascicoloResponse {

    @XmlElementRef(name = "return", namespace = "http://fascicolazione.docer.kdm.it", type = JAXBElement.class, required = false)
