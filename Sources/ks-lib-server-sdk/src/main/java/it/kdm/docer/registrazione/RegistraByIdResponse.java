...
@XmlRootElement(name = "registraByIdResponse")
public class RegistraByIdResponse {

    @XmlElementRef(name = "return", namespace = "http://registrazione.docer.kdm.it", type = JAXBElement.class, required = false)
