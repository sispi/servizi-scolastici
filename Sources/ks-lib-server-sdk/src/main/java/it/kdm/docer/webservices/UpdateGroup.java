 ...
 *         &lt;element name="groupInfo" type="{http://classes.sdk.docer.kdm.it/xsd}KeyValuePair" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class UpdateGroup {
    ...
    protected List<KeyValuePair> groupInfo;
     ...
     * 
     */
    public List<KeyValuePair> getGroupInfo() {
        if (groupInfo == null) {
            groupInfo = new ArrayList<KeyValuePair>();
        }
