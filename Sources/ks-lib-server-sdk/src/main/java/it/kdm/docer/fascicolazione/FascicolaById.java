...
public class FascicolaById {
    ...
    @XmlElementRef(name = "datiFascicolo", namespace = "http://fascicolazione.docer.kdm.it", type = JAXBElement.class, required = false)
    protected JAXBElement<String> datiFascicolo;
     ...
     *     
     */
    public JAXBElement<String> getDatiFascicolo() {
     ...
     *     
     */
    public void setDatiFascicolo(JAXBElement<String> value) {
