...
@XmlRootElement(name = "getDocumentTypesByAOO")
public class GetDocumentTypesByAOO {
    ...
    @XmlElementRef(name = "codiceAOO", namespace = "http://webservices.docer.kdm.it", type = JAXBElement.class, required = false)
