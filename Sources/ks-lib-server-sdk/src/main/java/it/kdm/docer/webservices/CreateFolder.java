 ...
 *         &lt;element name="folderInfo" type="{http://classes.sdk.docer.kdm.it/xsd}KeyValuePair" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class CreateFolder {
    ...
    protected List<KeyValuePair> folderInfo;
     ...
     * 
     */
    public List<KeyValuePair> getFolderInfo() {
        if (folderInfo == null) {
            folderInfo = new ArrayList<KeyValuePair>();
        }
