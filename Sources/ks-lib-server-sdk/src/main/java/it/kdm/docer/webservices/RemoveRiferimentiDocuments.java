 ...
 *         &lt;element name="riferimenti" type="{http://www.w3.org/2001/XMLSchema}string" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "removeRiferimentiDocuments")
public class RemoveRiferimentiDocuments {
    ...
    protected List<String> riferimenti;
    ...
    public List<String> getRiferimenti() {
        if (riferimenti == null) {
            riferimenti = new ArrayList<String>();
        }
