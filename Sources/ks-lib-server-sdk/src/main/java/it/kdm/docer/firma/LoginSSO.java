...
public class LoginSSO {
    ...
    @XmlElementRef(name = "saml", namespace = "http://firma.docer.kdm.it", type = JAXBElement.class, required = false)
    protected JAXBElement<String> saml;
    @XmlElementRef(name = "codiceEnte", namespace = "http://firma.docer.kdm.it", type = JAXBElement.class, required = false)
