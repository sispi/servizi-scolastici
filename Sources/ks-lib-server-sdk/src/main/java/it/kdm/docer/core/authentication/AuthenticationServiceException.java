...
public class AuthenticationServiceException {
    ...
    @XmlElementRef(name = "AuthenticationServiceException", namespace = "http://authentication.core.docer.kdm.it", type = JAXBElement.class, required = false)
    protected JAXBElement<Exception> authenticationServiceException;
     ...
     *     
     */
    public JAXBElement<Exception> getAuthenticationServiceException() {
     ...
     *     
     */
    public void setAuthenticationServiceException(JAXBElement<Exception> value) {
