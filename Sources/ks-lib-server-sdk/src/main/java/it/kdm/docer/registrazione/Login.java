...
public class Login {
    ...
    @XmlElementRef(name = "userId", namespace = "http://registrazione.docer.kdm.it", type = JAXBElement.class, required = false)
    protected JAXBElement<String> userId;
    @XmlElementRef(name = "password", namespace = "http://registrazione.docer.kdm.it", type = JAXBElement.class, required = false)
