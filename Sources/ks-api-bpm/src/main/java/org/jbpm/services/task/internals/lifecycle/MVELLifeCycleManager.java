...
//            }
    ...
    /**
     * This method will potentially assign the actual owner of this TaskData and
     * set the status of the data.
     * <li>If there is only 1 potential owner, and it is a <code>User</code>,
     * that will become the actual owner of the TaskData and the status will be
     * set to <code>Status.Reserved</code>.</li>
     * <li>f there is only 1 potential owner, and it is a <code>Group</code>, no
     * owner will be assigned and the status will be set to
     * <code>Status.Ready</code>.</li>
     * <li>If there are more than 1 potential owners, the status will be set to
     * <code>Status.Ready</code>.</li>
