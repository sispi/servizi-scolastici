...
public class SwaggerConfiguration {
    ...
    public Docket docket() {
        return new Docket(DocumentationType.SWAGGER_2)
            .select()
            .apis(RequestHandlerSelectors.basePackage("it.filippetti.ks.api.bpm.endpoint"))
            .paths(PathSelectors.regex("/.*"))
            .build()
            .pathMapping("/")
            .useDefaultResponseMessages(false)
            .additionalModels(typeResolver.resolve(CreateDeploymentDTO.class))
