...
public class EndpointExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<?> handleAuthorizationException(
        AuthorizationException exception, WebRequest request) {
    ...
    public ResponseEntity<?> handleBusinessException(
        ...
        return ResponseEntity
            ...
            .body(new ErrorDTO(
                ...
                exception.getBusinessError().code(), 
                exception.getMessage(),
                exception.getDetails()));
    }
    
    /**
     * Instance execution errors
     * 
     * @param exception
     * @param request
     * @return 
     */
    @ExceptionHandler(value = {WorkflowRuntimeException.class, WorkflowException.class})
    public ResponseEntity<?> handleWorkflowRuntimeException(
        WorkflowRuntimeException exception, WebRequest request) {
        ...
        return ResponseEntity
            ...
            .body(new ErrorDTO(
                HttpStatus.UNPROCESSABLE_ENTITY.value(),
                BusinessError.INSTANCE_WORKFLOW_ERROR.code(), 
                BusinessException.DEFAULT_MESSAGE,
                Lists.newArrayList(exception.getMessage())));
    }    
    ...
    public ResponseEntity<?> handleOperationException(
