...
public class ProceedingDTO {
    ...
    @ApiModelProperty(position = 2, notes = "The service") 
    private ServiceDTO service;
    
    @ApiModelProperty(position = 3, example = "Rilascio licenza di pesca") 
    ...
    @ApiModelProperty(position = 6, example = "test") 
    ...
    @ApiModelProperty(position = 25, example = "nulla_osta_porto_darmi.js")
    private String customTemplate;
    
    @ApiModelProperty(position = 26, example = "false")
    private Boolean showCustomTemplate;
    
    @ApiModelProperty(position = 27, example = "false")
    private Boolean uniqueInstance;
    
    @ApiModelProperty(position = 28, example = "false")
    private Boolean sendIfExpired;
    
    @ApiModelProperty(position = 29, example = "false")
    ...
    @ApiModel("Page<Proceeding>")
    public static class Page extends PageDTO<ProceedingDTO> {}
