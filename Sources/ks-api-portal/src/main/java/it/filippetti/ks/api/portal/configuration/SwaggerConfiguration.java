...
import it.filippetti.ks.api.portal.dto.VoidDTO;
...
public class SwaggerConfiguration {
    ...
    public Docket docket() {
        return new Docket(DocumentationType.SWAGGER_2)
            .select()
            .apis(RequestHandlerSelectors.basePackage("it.filippetti.ks.api.portal.endpoint"))
